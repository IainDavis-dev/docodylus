...
import { DocodylusTypeError, newExpectedArrayError, newInvalidLocaleError, newInvalidNamespaceError } from "./DocodylusTypeError";
...
describeUnitTest("DocodylusTypeError", () => {
    ...
    `("Concrete Error Factories", ({funcName, purpose, factoryFunc, args, message, details, subtype, scope, reference }) => {
        ...
        it(`${funcName} should create an error that ${purpose}`, () => {
            ...
            [Error, TypeError, DocodylusTypeError].forEach((type: any) => {
