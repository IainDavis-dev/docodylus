...
describeUnitTest("LocaleAwarePolyglot", () => {
    ...
    describe("localizing strings", () => {
        ...
        it(`falls back to a default locale ("${DEFAULT_LOCALE}") if no matching string is available`, () => {
            ...
            // note, in the running code, these translations are staged by the with the useTranslations hook, transparent to the component. Here, we have to explicitly add it so the default translation will be available.
